...
class TelegramMessageProcessor:
    ...
    def _classify_intent(self, text: str, user_id: int) -> dict:
        ...
        patterns = IntentPattern.objects.filter(
            is_active=True
        ).order_by('-accuracy_rate', '-usage_count')
    ...
    def _store_classified_message(self, text: str, user_id: int, intent: str, confidence: float, pattern: IntentPattern):
