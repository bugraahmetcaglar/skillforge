...
class ContactAdmin(admin.ModelAdmin):
    ...
    search_fields = ["first_name", "last_name", "full_name", "email", "mobile_phone", "organization", "job_title"]
    ...
    # Readonly fields
    readonly_fields = ["id", "created_at", "last_updated", "imported_at", "external_id", "deactivated_at"]
    ...
    fieldsets = (
        ...
        ("Personal Information", {"fields": ("birthday", "anniversary", "notes"), "classes": ("collapse",)}),
        ("Import Information", {"fields": ("import_source", "external_id", "imported_at"), "classes": ("collapse",)}),
        (
            "System Information",
            {
                "fields": ("id", "owner", "is_active", "created_at", "last_updated", "deactivated_at"),
                "classes": ("collapse",),
            },
        ),
    )
    ...
    def deactivate_contacts(self, request: HttpRequest, queryset: QuerySet) -> None:
        ...
        self.message_user(request, f"Successfully deactivated {count} contact(s).")
